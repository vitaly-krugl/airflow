...
def run(args, dag=None):
    ...
    if os.path.exists(filename):
        ...
        # Upload logs to NetStorage
        from logging_backup.netstorage_hook import NetStorageLog
        NetStorageLog().write(log, remote_log_location)
...
def restart_workers(gunicorn_master_proc, num_workers_expected, master_timeout):
    ...
    try:
        ...
        logging.error(err)
        logging.error("Shutting down webserver")
        try:
